 ...
 * @license MIT
 */
$this->setVar('title', lang('Admin.Cells') . ' / ' . lang('Admin.Site Contact Us'));
$this->setVar('h1', lang('Admin.Cells'));
$this->setVar('description', lang('Admin.Site Contact Us'));
$this->setVar('activeMenu', 'site-contact-us');
...
<?= form_open('admin/site-contact-us');?>
