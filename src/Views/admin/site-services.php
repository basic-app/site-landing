 ...
 * @license MIT
 */
$this->setVar('title', lang('Admin.Cells') . ' / ' . lang('Admin.Site Services'));
$this->setVar('h1', lang('Admin.Cells'));
$this->setVar('description', lang('Admin.Site Services'));
$this->setVar('activeMenu', 'site-services');
